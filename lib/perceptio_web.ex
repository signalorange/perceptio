defmodule PerceptioWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: PerceptioWeb.Layouts]

      import Plug.Conn
      import PerceptioWeb.Gettext
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {PerceptioWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import PerceptioWeb.CoreComponents
      import PerceptioWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: PerceptioWeb.Endpoint,
        router: PerceptioWeb.Router,
        statics: PerceptioWeb.static_paths()
    end
  end
